...
const DaniHotels = () => {
  ...
  return (
    <div className="p-4 md:p-10">
      ...
      <div className='my-5'>
        <h1 className='text-3xl tracking-wide text-center md:text-start mb-3'>Aroma restaurant</h1>
        <p className='text-justify lg:text-lg tracking-wide'>With minimalism and accents from the color palette, we chose continuity with the hotel. This restaurant can comfortably house 60 people. Themed with warmness, the simplicity of this restaurant is adorned and highlighted by using brick walls by our adroit team of designers.</p>
      </div>

      <div className='my-5'>
        <h1 className='text-3xl tracking-wide text-center md:text-start mb-3'>Scenic views.</h1>
        <p className='text-justify lg:text-lg tracking-wide'>The top floor of this palatial hotel has a small swimming pool keeping the structural load in balance. Our guests enjoy this part of their vacation by spending quality time watching the sun descend from the mountains. The Cheiraou Ching views give you a memorable company!</p>
      </div>
      </div>
        ...
        <div className="md:flex justify-between overflow-hidden">
          {images.map((image, index) => (
            <img
              ...
              src={image}
              alt=""
              className="md:w-[415px] mb-5 cursor-pointer"
