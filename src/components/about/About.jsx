        ...
        <>
            ...
            <div className=' px-5 md:pb-5 mb-10'>
                <div className='lg:w-[85%] mx-auto'>
                    <h1 className='text-2xl text-center text-gray-700 md:text-3xl tracking-wider font-semibold mb-3'>What Sets Us Apart</h1>
                    <p className='text-justify md:text-center'> <span className='font-semibold'>Custom Solutions:</span> Every project is a fresh canvas. We pride ourselves on bespoke designs that reflect your individuality.</p>
                    <p className='text-justify md:text-center'> <span className='font-semibold'>Attention to Detail: </span>From concept to completion, we obsess over the little things that make a big difference.</p>
                </div>

                <div className=' my-5 pt-5 lg:w-[85%] mx-auto'>
                    <h1 className='text-2xl text-center text-gray-700 md:text-3xl tracking-wider font-semibold mb-3'>Let’s Create Together</h1>
                    <p className='text-justify lg:w-[75%] mx-auto'>Whether you’re starting from scratch or revamping an existing space, Canwill Design is here to transform your ideas into reality. Let’s build something extraordinary.</p>
                </div>
            </div>
