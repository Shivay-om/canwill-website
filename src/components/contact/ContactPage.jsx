...
const ContactPage = () => {
  return (
    <>
      <div>
        <Helmet>
          <title>Connect with Mumbai’s Best Interior Designers Today!</title>
          <meta name="description" content="Let’s create something extraordinary. Contact Can Will Design for bespoke interiors & architectural expertise. Elevate your space—talk to us now!" />
        </Helmet>
          ...
          <div className=' md:w-[50%]  lg:w-[60%] text-gray-700 md:py-10 lg:p-10  border-black'>
            ...
            <div className=' border-black lg:flex'>
              ...
              <div className='flex flex-col justify-center md:w-[50%] lg:pl-14 md:h-auto gap-5 md:gap-10 border-green-400'>
                ...
                <div className='flex flex-col justify-center md:justify-start md:items-start my-5 md:my-0 items-center'>
                  <h1 className='mb-3 text-[#1E1E1E] text-lg text-opacity-75 tracking-wider'>Address</h1>
                  <p className='text-center md:text-start tracking-wide'>Canwill Design Associates, E-04, Gokul Residency, Thakur Village, Kandivali(E), Mumbai - 40010</p>
                </div>
